/*
  ...
  @brief Interface OLED SSD-1306 display to Aries v3.0 Board
  ...
  Library Required: VEGA_SH1106 (Version 1.0.0)
                    Adafruit GFX Library (Version 1.11.3)
                    Adafruit BusIO

  Link to download VEGA SH1106 library: https://gitlab.com/riscv-vega/vega-sensor-libraries/display/vega_sh1106 
